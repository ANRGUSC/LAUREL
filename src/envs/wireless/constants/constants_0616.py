# ------ simplified wireless simulation -------------------------------
# assume agents can always hear others transmit; with pcsma, agents within a batch never send at the same time --> no collision
SIMPLIFIED = True    
num_max_msg = 3 # max number of msgs can be transmitted in the wireless channel
#----------------------------------------------------------------------
